    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDbContext>(sp =>
            {
                ...
                {
                    ConnectionString = Environment.GetEnvironmentVariable("MONGO_CONNECTIONSTRING"), //this.Configuration.GetSection("Mongo:ConnectionString").Get<string>(),
                    DataBase = Environment.GetEnvironmentVariable("MONGO_DATABASE")  //this.Configuration.GetSection("Mongo:DataBase").Get<string>()
                };
            });
